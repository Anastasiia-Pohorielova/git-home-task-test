...
namespace WebApi.Controllers
{
    ...
    public class StudentController : ControllerBase
    {
        ...
        // POST api/Student/
        [HttpPost]
        public ActionResult Post(StudentDto value)
        {
            var createStudent = _studentService.CreateStudent(value.ToModel());
            if (createStudent.HasErrors)
            {
                return BadRequest(createStudent.Errors);
            }
            return Accepted();
        }
