...
namespace WebApi.Controllers
{
    ...
    public class CourseController : ControllerBase
    {
        ...
        // POST api/Course/
        [HttpPost]
        public ActionResult Post(CourseDto value)
        {
            var createCourse = _courseService.CreateCourse(value.ToModel());
            if (createCourse.HasErrors)
            {
                return BadRequest(createCourse.Errors);
            }
            return Accepted();
        }
